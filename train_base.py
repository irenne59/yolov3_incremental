...
def train(
    ...
    if opt.resume or opt.transfer:  # Load previously saved model
        ...
        else:  # resume from latest.pt // previous weight path
            chkpt = torch.load(previousWeightPath, map_location=device)  # load checkpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='E:/research/_mine/yolov3-pytorch/dataset/baseline_voc/yolov3.cfg', help='cfg file path')
    parser.add_argument('--data-cfg', type=str, default='E:/research/_mine/yolov3-pytorch/dataset/baseline_voc/local/base_voc_local.data', help='base_voc.data file path')
    parser.add_argument('--outputPath', type=str, default='E:/research/_mine/yolov3-pytorch/weights/', help='output file path')
    parser.add_argument('--taskName', type=str, default='base_voc', help='task name')
    parser.add_argument('--previousWeightPath', type=str, default='E:/research/_mine/yolov3-pytorch/weights/base_voc/base_weight_e1_190806.pt', help='previous weight file path')
